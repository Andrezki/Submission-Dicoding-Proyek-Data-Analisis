...
import urllib
import sys
sys.path.append("C:\Users\user\Downloads\E-commerce-public-dataset\Func.py")
...
all_df = pd.read_csv(r"C:\Users\user\Downloads\E-commerce-public-dataset\E-Commerce Public Dataset\main_data.csv")
all_df.sort_values(by="order_approved_at", inplace=True)
all_df.reset_index(inplace=True)

# Geolocation Dataset
geolocation = pd.read_csv(r"C:\Users\user\Downloads\E-commerce-public-dataset\E-Commerce Public Dataset\geolocation_dataset.csv")
...
st.caption('Copyright (C) Andrezki Pramudya 2023')
